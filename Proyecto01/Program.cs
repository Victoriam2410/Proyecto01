...
void MenuPrincipal ()
{
    ...
    do
    {
        ...
        {
            Console.WriteLine("Error: Ingrese las opciones validas. (1, 2, 3, 4, 5):");
        }
        switch (option)
        {
            case 1:
...
void ValidacionDatosP() //pelicula
{
    ...
    if (cumpleDuracion && cumpleHora && cumpleProduccion)
    {
        if (produccionUno == 3 || duracionPeli > 120 || (horaUno >= 20 && horaUno <= 23))
        {
            ...
            Console.WriteLine("Presione ENTER o cualquier tecla para ir al menú.\n");
            Console.ReadKey();
        }
    ...
    else
    {
        ...
        Console.WriteLine("Precione ENTER o cualquier tecla para ir al menú");
        Console.ReadKey();
    }
}
